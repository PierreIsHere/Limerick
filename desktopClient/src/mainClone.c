...
GtkBuilder *builder;
GtkWidget *serverWindow,*ipAddrBox,*ipPop;
GtkWidget *userName, *userPass, *loginWindow;
...
int main(int argc, char *argv[])
{
    ...
    serverWindow = GTK_WIDGET(gtk_builder_get_object(builder, "serverWindow"));
